...
```text
 ...
 Marketing API          User Preferences          Content API
...
Ainnova Content Studio, frontend ve backend katmanlarının ayrıldığı modern bir web uygulaması mimarisi kullanmaktadır.

- **Frontend katmanı:** React.js ve Vite kullanılarak geliştirilmiştir.
- **İletişim katmanı:** Axios aracılığıyla REST API üzerinden sağlanmaktadır.
- **Backend katmanı:** Django REST Framework ile geliştirilmiştir.
- **Kimlik doğrulama:** JWT tabanlı authentication sistemi kullanılmıştır.
- **Veri yönetimi:** Django ORM aracılığıyla gerçekleştirilmektedir.
- **Veri tabanı:** SQLite kullanılmaktadır.

Bu mimari yapı, uygulamanın ölçeklenebilir, güvenli ve sürdürülebilir olmasını sağlamaktadır.
